...
import 'schema/admin_folders_record.dart';
...
export 'schema/admin_folders_record.dart';
...
/// Functions to query AdminFoldersRecords (as a Stream and as a Future).
Future<int> queryAdminFoldersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AdminFoldersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AdminFoldersRecord>> queryAdminFoldersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AdminFoldersRecord.collection,
      AdminFoldersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AdminFoldersRecord>> queryAdminFoldersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
