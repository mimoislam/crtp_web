...
import 'detail_popup_model.dart';
...
class _DetailPopupWidgetState extends State<DetailPopupWidget>
    with TickerProviderStateMixin {
  late DetailPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailPopupModel());
